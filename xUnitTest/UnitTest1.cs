    ...
    public class UnitTest1
    {
        ...
        public void ReturnFalse_GivenDuplicatedItemNameAndItemType_RegisteringJSON()
        {
            ...
            try
            {
                ...
                formulatrix.Register("item1", "{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix 1\"}", 1);
                formulatrix.Register("item1", "{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix 2\"}", 1);
        ...
        public void ReturnFalse_GivenDuplicatedItemNameAndItemType_RegisteringXML()
        {
            ...
            {
                // Duplicating itemType and itemName
                formulatrix.Register("item2", "<name>banu</name><email>banu.hutomo@gmail.com</email><contents>test formulatrix</contents>", 2);
                formulatrix.Register("item2", "<name>banu</name><email>banu.hutomo@gmail.com</email><contents>test formulatrix</contents>", 2);
        ...
        public void ReturnFalse_GivenNoInputParameters_Registering()
        {
            ...
            {
                // Duplicating itemType and itemName
                formulatrix.Register("", "{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix\"}", 1);
        ...
        {
            formulatrix.Register("item1", "{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix\"}", 1);
        ...
        {
            formulatrix.Register("item2", "<name>banu</name><email>banu.hutomo@gmail.com</email><contents>test formulatrix</contents>", 2);
            Assert.Equal("<root><name>banu</name><email>banu.hutomo@gmail.com</email><contents>test formulatrix</contents></root>", formulatrix.Retrieve("item2"));
        ...
        {
            formulatrix.Register("item1", "{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix\"}", 1);
            Assert.Equal("{\"name\":\"banu\",\"email\":\"banu.hutomo@gmail.com\",\"contents\":\"test formulatrix\"}", formulatrix.Retrieve("item1"));
